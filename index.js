...
function findLargestInteger(integers) {
  ...
  return result
  // integers = [1, 10, 7, 8]
  // console.log(Math.max.apply(Math, integers)) 
  // // findLargestInteger takes an array of objects
  // // take each value from the key value pairs and put them into an array
  // // use Math.max.apply(Math.integers) on the array to get the largest number
